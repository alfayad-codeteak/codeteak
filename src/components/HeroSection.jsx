...
/>
      ...
      <h2 className="text-xl mt-5 flex items-center justify-center font-medium font-wave">
        Create Your Own 
        <RotatingText
  texts={['App ?', 'Website ?', 'Desing ?', 'Software ?']}
...
/>
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      ...
      <BlurText
  text="Preline UI is an open-source set of prebuilt UI components, ready-to-use examples and Figma design system based on the utility-first Tailwind CSS framework."
  delay={250}
  animateBy="words"
  direction="top"
...
/>
 ...
 <a className="inline-flex justify-center items-center gap-x-3 text-center bg-linear-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 border  text-red-600 text-sm font-bold rounded-md focus:outline-hidden focus:from-violet-600 focus:to-blue-600 py-3 px-4" href="#">
        Get started
        <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
      </a>
</Magnet>
